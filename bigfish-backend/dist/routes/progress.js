...
import { markMaterialViewed, getViewedMaterialIds, isMaterialViewed, updateDailyActivity, getRecentActivity, calculateStreak, getUserStats, syncViewedMaterials, } from '../services/progress.service.js';
const router = Router();
 ...
 */
router.post('/goals/:id/toggle', requireAuth, asyncHandler(async (req, res) => {
