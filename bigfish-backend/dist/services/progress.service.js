...
export async function markMaterialViewed(_userId, _materialId, _timeSpent) {
    return;
}
export async function getViewedMaterialIds(_userId) {
    return [];
}
export async function isMaterialViewed(_userId, _materialId) {
    return false;
}
export async function getMaterialViewStats(_materialIds) {
    return {};
}
export async function updateDailyActivity(userId, updates) {
...
export async function syncViewedMaterials(_userId, localMaterialIds) {
