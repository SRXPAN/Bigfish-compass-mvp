 ...
 */
export async function markMaterialViewed(userId, materialId, timeSpent) {
 ...
 */
export async function getViewedMaterialIds(userId) {
 ...
 */
export async function isMaterialViewed(userId, materialId) {
 ...
 */
export async function getMaterialViewStats(materialIds) {
 ...
 */
export async function syncViewedMaterials(userId, localMaterialIds) {
