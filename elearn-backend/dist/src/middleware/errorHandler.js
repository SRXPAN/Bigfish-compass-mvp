...
function mapPrismaError(err) {
    ...
    switch (err.code) {
        ...
        case 'P2003': {
            ...
            const field = err.meta?.field_name || 'related resource';
        ...
        case 'P2014': {
            ...
            return AppError.badRequest('Cannot perform operation: required relations exist', { constraint: 'required_relation' });
        }
        case 'P2015': {
...
export function errorHandler(err, req, res, _next) {
    ...
    if (err instanceof Prisma.PrismaClientKnownRequestError) {
        ...
        sendError(res, appError.code, appError.message, appError.statusCode, appError.details);
        return;
    }
    ...
    if (err.type === 'entity.too.large') {
        logger.warn('Payload too large:', { ...errorContext, size: err.length });
