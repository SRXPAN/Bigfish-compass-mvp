...
export const generalLimiter = rateLimit({
    windowMs: Number(process.env.RL_GENERAL_WINDOW_MS ?? 60000), // 1 хв
...
export const authLimiter = rateLimit({
    windowMs: Number(process.env.RL_AUTH_WINDOW_MS ?? 15 * 60000), // 15 хв
...
export const webhookLimiter = rateLimit({
    windowMs: Number(process.env.RL_WEBHOOK_WINDOW_MS ?? 60000), // 1 хв
