...
export function generateFileKey(category, originalName) {
 ...
 */
export async function getPresignedUploadUrl(key, mimeType, expiresIn = 3600) {
...
export function validateFile(category, mimeType, size) {
