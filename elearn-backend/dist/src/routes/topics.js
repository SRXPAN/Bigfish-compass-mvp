 ...
 */
router.get('/', optionalAuth, validateResource(topicSchemas.pagination, 'query'), asyncHandler(async (req, res) => {
    // TypeScript safe casting based on Zod schema defaults
    const { page, limit, category, lang, search } = req.query;
 ...
 */
router.get('/tree', optionalAuth, validateResource(langQuerySchema, 'query'), asyncHandler(async (req, res) => {
...
validateResource(langQuerySchema, 'query'), asyncHandler(async (req, res) => {
