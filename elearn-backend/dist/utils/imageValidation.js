 ...
 */
export function validateImageBase64(dataUrl) {
 ...
 */
function mimeTypesMatch(declared, actual) {
    // Нормалізуємо типи
 ...
 */
function containsSuspiciousContent(buffer) {
 ...
 */
export async function optimizeImageBase64(dataUrl) {
